...
const FixedSalary = () => {
  ...
  const fetchData = async () => {
    ...
    const response = await fetch(`${phpBaseURL}/fetch_dspEdsp_fix_salary.php`, {
      method: "POST",
  ...
  const columns = [
    ...
    { field: "EMP ID", headerName: "Employee ID", width: 150 },
    ...
    // { field: "Employee Name", headerName: "Employee Name", width: 180 },
    !isDualRole && { field: "Salary", headerName: "Salary", width: 120 },
    { field: "Fuel", headerName: "Fuel", width: 100 },
    { field: "PHONE", headerName: "Phone", width: 140 },
    // { field: "Month", headerName: "Month", width: 120 },
    { field: "Month Days", headerName: "Month Days", width: 130 },
    { field: "Present", headerName: "Present", width: 110 },
    { field: "Absent", headerName: "Absent", width: 110 },
    {
    ...
    { field: "Extra_Days", headerName: "Extra Days", width: 130 },
    !isDualRole && {
  ...
  const handleUpdateExtraDays = async () => {
    ...
    try {
        // const response = await fetch(`${baseURL}/update_extra_days`, {
        // method: "PUT",
        const response = await fetch(`${phpBaseURL}/update_extra_days.php`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
